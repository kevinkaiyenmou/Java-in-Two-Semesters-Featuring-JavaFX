...
public class MetricConverter extends Application {
      final static int PREF_WIDTH = 25; // pixels
      ...
      public void start(Stage stage) {
            ...
            celsiusLabel.setStyle("-fx-pref-width: " + PREF_WIDTH + "px");
            TextField fahrenheitText = new TextField();
            Label fahrenheitLabel = new Label("℉");
            fahrenheitLabel.setStyle("-fx-pref-width: " + PREF_WIDTH + "px");
            ...
            HBox celsiusFahrenheitPanel = new HBox(10);
            celsiusFahrenheitPanel.getChildren().addAll(celsiusText, celsiusLabel, celsiusFahrenheitButtons,
                        fahrenheitText, fahrenheitLabel);

            // create a VBox to hold all three rows
            VBox root = new VBox(10);
            root.getChildren().addAll(inchCmPanel, mileKmPanel, poundKgPanel, celsiusFahrenheitPanel);
            ...
            celsiusToFahrenheitButton.setOnAction(e -> {
                  String s = new String(celsiusText.getText());
                  double d = Double.parseDouble(s);
                  d = d * (180 / 100) + 32;
                  s = df.format(d);
            ...
            fahrenheitToCelsiusButton.setOnAction(e -> {
                  String s = new String(fahrenheitText.getText());
                  double d = Double.parseDouble(s);
                  d = (d - 32) * (5 / 9);
                  s = df.format(d);
